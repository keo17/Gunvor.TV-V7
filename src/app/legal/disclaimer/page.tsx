    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-3xl mx-auto shadow-lg">
        ...
        <CardContent className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-invert mx-auto">
          <p>
            This Legal Disclaimer governs your use of the Gunvor.TV platform. By accessing or using our services,
            you agree to the terms outlined in this disclaimer.
          </p>
          
          <h2 className="text-xl font-semibold mt-6 mb-2">No Legal Advice</h2>
          <p>
            The information provided on Gunvor.TV is for general informational purposes only. It is not intended as,
          ...
          <p>
            All content available on Gunvor.TV, including text, graphics, logos, icons, images, audio clips, video clips,
            and software, is the property of Gunvor.TV or its content suppliers and protected by international
            copyright laws. The compilation of all content on this site is the exclusive property of Gunvor.TV.
          ...
          <p>
            Gunvor.TV endeavors to provide accurate and up-to-date information. However, we make no warranties or
          ...
          <p>
            Gunvor.TV may display content sourced from third parties or provide links to third-party websites.
          ...
          <p>
            Gunvor.TV reserves the right to modify this Legal Disclaimer at any time. We encourage you to review
